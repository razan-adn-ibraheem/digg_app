            ...
            <div className="container">
                ...
                >
                    <div className="q_form">
                        <p>{Questions.step4.q1.text}</p>
                        <Form.Item name="f_1_four" rules={[{ required: true, message: 'cannot be empty!' }]}>
                            <Radio.Group onChange={onChange} name="f_1_four" >

                                {Questions.step4.q1.choices.map((choice, index) =>
