            ...
            <div className="container">
                ...
                >
                    <div className="q_form">
                        <p>{Questions.step8.q1.text}</p>
                        <Form.Item name="f_1_eight" rules={[{ required: true, message: 'cannot be empty!' }]}>
                            <Radio.Group onChange={onChange} name="f_1_eight" >

                                {Questions.step8.q1.choices.map((choice, index) =>
