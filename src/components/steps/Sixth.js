            ...
            <div className="container">
                ...
                >
                    <div className="q_form">
                        <p>{Questions.step6.q1.text}</p>
                        <Form.Item name="f_1_six" rules={[{ required: true, message: 'cannot be empty!' }]}>
                            <Radio.Group onChange={onChange} name="f_1_six" >

                                {Questions.step6.q1.choices.map((choice, index) =>
